...
func (s Node) SetStruct() { s.Struct.SetUint16(12, 1) }

func (s Node_struct) DataWordCount() uint16 {
	return s.Struct.Uint16(14)
}

func (s Node_struct) SetDataWordCount(v uint16) {

	s.Struct.SetUint16(14, v)
}

func (s Node_struct) PointerCount() uint16 {
	return s.Struct.Uint16(24)
}

func (s Node_struct) SetPointerCount(v uint16) {

	s.Struct.SetUint16(24, v)
}

func (s Node_struct) PreferredListEncoding() ElementSize {
	return ElementSize(s.Struct.Uint16(26))
}

func (s Node_struct) SetPreferredListEncoding(v ElementSize) {

	s.Struct.SetUint16(26, uint16(v))
}

func (s Node_struct) IsGroup() bool {
	return s.Struct.Bit(224)
}

func (s Node_struct) SetIsGroup(v bool) {

	s.Struct.SetBit(224, v)
}

func (s Node_struct) DiscriminantCount() uint16 {
	return s.Struct.Uint16(30)
}

func (s Node_struct) SetDiscriminantCount(v uint16) {

	s.Struct.SetUint16(30, v)
}

func (s Node_struct) DiscriminantOffset() uint32 {
	return s.Struct.Uint32(32)
}

func (s Node_struct) SetDiscriminantOffset(v uint32) {

	s.Struct.SetUint32(32, v)
}

func (s Node_struct) Fields() (Field_List, error) {
...
func (s Node_struct) HasFields() bool {
	p, err := s.Struct.Ptr(3)
	return p.IsValid() || err != nil
}

func (s Node_struct) SetFields(v Field_List) error {
...
func (p Node_Promise) Struct() Node_struct_Promise { return Node_struct_Promise{p.Pipeline} }

// Node_struct_Promise is a wrapper for a Node_struct promised by a client call.
type Node_struct_Promise struct{ *capnp.Pipeline }

func (p Node_struct_Promise) Struct() (Node_struct, error) {
	s, err := p.Pipeline.Struct()
...
func (s Type) SetStruct() { s.Struct.SetUint16(0, 16) }

func (s Type_struct) TypeId() uint64 {
	return s.Struct.Uint64(8)
}

func (s Type_struct) SetTypeId(v uint64) {

	s.Struct.SetUint64(8, v)
}

func (s Type_struct) Brand() (Brand, error) {
	p, err := s.Struct.Ptr(0)
	if err != nil {
		return Brand{}, err
	}
...
func (s Type_struct) HasBrand() bool {
	p, err := s.Struct.Ptr(0)
	return p.IsValid() || err != nil
}

func (s Type_struct) SetBrand(v Brand) error {
...
// NewBrand sets the brand field to a newly
// allocated Brand struct, preferring placement in s's segment.
func (s Type_struct) NewBrand() (Brand, error) {
...
func (p Type_Promise) Struct() Type_struct_Promise { return Type_struct_Promise{p.Pipeline} }

// Type_struct_Promise is a wrapper for a Type_struct promised by a client call.
type Type_struct_Promise struct{ *capnp.Pipeline }

func (p Type_struct_Promise) Struct() (Type_struct, error) {
	s, err := p.Pipeline.Struct()
...
func (s Value) Struct() (capnp.Pointer, error) {

	return s.Struct.Pointer(0)

}

func (s Value) HasStruct() bool {
	p, err := s.Struct.Ptr(0)
	return p.IsValid() || err != nil
}

func (s Value) StructPtr() (capnp.Ptr, error) {

	return s.Struct.Ptr(0)

}

func (s Value) SetStruct(v capnp.Pointer) error {
	s.Struct.SetUint16(0, 16)
	return s.Struct.SetPointer(0, v)
}

func (s Value) SetStructPtr(v capnp.Ptr) error {
	s.Struct.SetUint16(0, 16)
	return s.Struct.SetPtr(0, v)
}
...
func (p Value_Promise) Struct() *capnp.Pipeline {
	return p.Pipeline.GetPipeline(0)
}
