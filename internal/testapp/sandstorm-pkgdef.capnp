...
const pkgdef :Spk.PackageDefinition = (
  ...
  id = "1gjvj4h4m898e01tjh6hqmc70ts6qa9ac2gz37tsjw00currvkxh",
  ...
  manifest = (
    ...
    appTitle = (defaultText = "go.sandstorm test app"),
    ...
    actions = [
      ...
      ( nounPhrase = (defaultText = "test grain"),
        command = .myCommand
    ...
    metadata = (
      ...
      shortDescription = (defaultText = "go.sandstorm test app"),
