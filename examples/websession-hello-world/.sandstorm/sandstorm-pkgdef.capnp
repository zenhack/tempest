...
const pkgdef :Spk.PackageDefinition = (
  ...
  id = "ratr8fn8f2aphzne31g689rep9x2vtu59ydxagfu9ftf5svxf110",
  ...
  manifest = (
    ...
    appTitle = (defaultText = "Hello World Go Sandstorm App"),
    ...
    metadata = (
      ...
      website = "https://github.com/zenhack/go.sandstorm",
      # This should be the app's main website url.

      codeUrl = "https://github.com/zenhack/go.sandstorm",
      ...
      shortDescription = (defaultText = "Example Go app"),
...
const myCommand :Spk.Manifest.Command = (
  ...
  argv = ["/opt/app/websession-hello-world"],
  environ = [
