...
func buildCapnpResponse(goCtx context.Context, goResponse *http.Response,
	...
	case 200, 201, 202:
		...
		// It works in these three cases, but this is really gross, and won't
		...
		setSuccessHeaders(wsResponse, goResponse)
		go func() {
	...
	case 400, 403, 404, 405, 406, 409, 410, 413, 414, 415, 418:
		...
		// FIXME don't break the abstaction boundary.
	...
	default:
		...
		if status >= 500 && status < 600 {
			...
			//
			// TODO: Log this somewhere? Set DescriptionHtml?
			go writeBody(ioutil.Discard)
		}
	}
}
...
func setSuccessHeaders(wsResponse *capnp.WebSession_Response, goResponse *http.Response) {
